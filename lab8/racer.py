...
# FPS
FPS = 60
FramePerSec = pygame.time.Clock()  # Set game speed
...
# Set fonts
font = pygame.font.SysFont("Verdana", 20)  # Display game scores
font_small = pygame.font.SysFont("Verdana", 20)
game_over = font.render("Game Over", True, BLACK)  # Display when game ends

background = pygame.image.load("images/AnimatedStreet.png")  # Load background image

# Create game window
screen = pygame.display.set_mode((400, 600))  # Create window
...
# Coin class added to track coin collection
...
# Game loop
background_y = 0  # Track background movement
while True:
